...
{
	String apiKey, emailSenderName, company, subjectVerifyEmail;
	String verifyEmailAppName;
	String usersCollectionURL;
	String emailUrl;
	
	String keyUsername, keyEmail, keyPassword, keyName, keyIsEmailVerified;
	...
	public void setKeyIsEmailVerified(String keyIsEmailVerified) {
		this.keyIsEmailVerified = keyIsEmailVerified;
	}

	public String getKeyIsEmailVerified() {
		return keyIsEmailVerified;
	}
	...
	public void setUsersCollectionURL(String usersCollectionURL) {
		this.usersCollectionURL = usersCollectionURL;
	}
	...
	public void setVerifyEmailAppName(String verifyEmailAppName) {
		this.verifyEmailAppName = verifyEmailAppName;
	}

	public String getVerifyEmailAppName() {
		return verifyEmailAppName;
	}
	...
	public void setSubjectVerifyEmail(String subjectVerifyEmail) {
		this.subjectVerifyEmail = subjectVerifyEmail;
	}

	public String getSubjectVerifyEmail() {
		return subjectVerifyEmail;
	}
}
