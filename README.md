...
You will need to setup restdb.io before using this library. Watch [this](https://youtu.be/_nxRzXg8mmw) video to learn what & how to setup the restdb.io database.
